...
CREATE TABLE `online_exam_table` (
  `online_exam_id` int(11) PRIMARY KEY NOT NULL,
...
CREATE TABLE `option_table` (
  `option_id` int(11) PRIMARY KEY NOT NULL,
...
CREATE TABLE `user_exam_enroll_table` (
  `user_exam_enroll_id` int(11) PRIMARY KEY  NOT NULL,
...
CREATE TABLE `user_exam_question_answer` (
  `user_exam_question_answer_id` int(11) PRIMARY KEY NOT NULL,
  `user_id` int(11) NOT NULL,
  `exam_id` int(11) NOT NULL,
  `question_id` int(11) NOT NULL,
